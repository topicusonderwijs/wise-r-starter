...
(function(root, factory) {
  ...
  describe('Link', function() {
    it('should create an instance of Link', function() {
      ...
      //var instane = new WiserClient.Link();
      //expect(instance).to.be.a(WiserClient.Link);
    });

    it('should have the property uriBuilder (base name: "uriBuilder")', function() {
      // uncomment below and update the code to test the property uriBuilder
      //var instane = new WiserClient.Link();
