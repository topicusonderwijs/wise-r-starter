...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Array.<String>} opts.schoollocations Filter on schoollocations (required, list of id&#39;s)
     * @param {Integer} opts.nextId ID that was returned the last time when retrieving Changes for this set of schoollocations. When empty, all Changes will be returned from the start.
