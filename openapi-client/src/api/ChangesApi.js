...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Integer} opts.nextId ID that was returned the last time when retrieving Changes for this set of schoollocations. When empty, only the last changes will be returned as a starting point for a new synchronisation of a schoollocation
